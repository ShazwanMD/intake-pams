...
SpringScenarioTest<GivenIAmInternationalOfficer, WhenPrepareApplicationSubmission, ThenValidateTheApplication> {
	 ...
	 public void scenario1() {
		 ...
		 when().I_prepare_3_applications().and().I_submit_3_applications();
			addStage(WhenViewApplicationWithInternationalAcademicQualification.class).and()
			.I_view_application_with_international_academic_qualification();
