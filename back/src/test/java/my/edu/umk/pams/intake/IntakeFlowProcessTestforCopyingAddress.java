...
public class IntakeFlowProcessTestforCopyingAddress {

    private static final Logger LOG = LoggerFactory.getLogger(IntakeFlowProcessTestforCopyingAddress.class);
