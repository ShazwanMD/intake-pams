...
@As("As a MGSEB academic administrator, I want to activate students admission during registration day, so that the student status will be activated")

public class US_IN_RGN_4006 extends SpringScenarioTest<GivenIAmMGSEBAdministrator, WhenActivateStudentAdmission, ThenActivateStudentStatus> {
