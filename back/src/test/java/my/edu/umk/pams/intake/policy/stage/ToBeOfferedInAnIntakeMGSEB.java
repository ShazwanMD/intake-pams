...
@JGivenStage
public class ToBeOfferedInAnIntakeMGSEB extends Stage<ToBeOfferedInAnIntakeMGSEB> {

	private static final Logger LOG = LoggerFactory.getLogger(ToBeOfferedInAnIntakeMGSEB.class);
