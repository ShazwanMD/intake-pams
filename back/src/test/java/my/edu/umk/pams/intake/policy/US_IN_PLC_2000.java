...
import my.edu.umk.pams.intake.policy.stage.ThenICanChooseFromASelectionOfChoices;
import my.edu.umk.pams.intake.policy.stage.ThenIntakeIsReadyForSetup;
import my.edu.umk.pams.intake.policy.stage.ToBeOfferedInAnIntake;
import my.edu.umk.pams.intake.policy.stage.WhenIAddIntake;
import my.edu.umk.pams.intake.policy.stage.WhenISelectMultipleProgramCode;
...
public class US_IN_PLC_2000 extends SpringScenarioTest<GivenIAmPPSAdministrator, WhenISelectMultipleProgramCode, ThenICanChooseFromASelectionOfChoices> {
    ...
    public void testScenario1() {
        ...
        addStage(ToBeOfferedInAnIntake.class).and().i_offer_an_intake();
