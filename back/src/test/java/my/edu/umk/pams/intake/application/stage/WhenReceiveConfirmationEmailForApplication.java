...
@JGivenStage
public class WhenReceiveConfirmationEmailForApplication extends Stage<WhenReceiveConfirmationEmailForApplication> {
    ...
    public WhenReceiveConfirmationEmailForApplication I_receive_confirmation_email() {
