							...
							if (identityService.isGroupExists(group.getName())) {
								...
								if (payload.getStaffDepartmentCode().equals("A10")) {
									...
									if (payload.getStaffCategory().equals("A")) {
										...
										try {
											// Group
											InGroup groupPegawaiA10 = identityService
								...
								// Setting roles of CPS
									...
									if (payload.getStaffCategory().equals("A")) {
										...
										try {
											// Group
											InGroup groupPegawaiA09 = identityService
								...
								// Setting roles of Others Faculty
									...
									if (payload.getStaffCategory().equals("A")) {
										...
										try {
											// Group
											InGroup groupAllFac = identityService.findGroupByName(
										...
										try {
											// Group
											InGroup groupAllFaculty = identityService.findGroupByName(
