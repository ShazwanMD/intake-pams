 ...
 * @since 1/13/14
 */
public class InMutableAclService extends InAclService implements MutableAclService {

    private Logger log = LoggerFactory.getLogger(my.edu.umk.pams.intake.security.integration.InMutableAclService.class);
    ...
    public InMutableAclService(DataSource dataSource, LookupStrategy lookupStrategy, AclCache aclCache) {
