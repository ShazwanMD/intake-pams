 ...
 * @since 1/13/14
 */
public class InAclService implements AclService {

    // ~ Static fields/initializers
    // =====================================================================================

    private Logger log = LoggerFactory.getLogger(my.edu.umk.pams.intake.security.integration.InAclService.class);
    ...
    public InAclService(DataSource dataSource, LookupStrategy lookupStrategy) {
