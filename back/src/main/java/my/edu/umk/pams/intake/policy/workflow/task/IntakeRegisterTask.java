...
@Component("intake_register_ST")
public class IntakeRegisterTask extends BpmnActivityBehavior
        implements ActivityBehavior {

    private static final Logger LOG = LoggerFactory.getLogger(IntakeRegisterTask.class);
    ...
    public void execute(ActivityExecution execution) throws Exception {
        ...
        // update flow state
        intake.getFlowdata().setState(InFlowState.REGISTERED);
