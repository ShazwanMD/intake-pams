...
public class CommonServiceImpl implements CommonService {
    ...
    @Autowired
    private InCampusCodeDao campusCodeDao;

    @Autowired
    private InCollegeCodeDao collegeCodeDao;
    ...
    @Autowired
    private InLocationCodeDao locationCodeDao;
    ...
    //====================================================================================================
    @Override
    public void saveCampusCode(InCampusCode campusCode) {
        campusCodeDao.save(campusCode, Util.getCurrentUser());
        sessionFactory.getCurrentSession().flush();
    }

    @Override
    public void updateCampusCode(InCampusCode campusCode) {
        campusCodeDao.update(campusCode, Util.getCurrentUser());
        sessionFactory.getCurrentSession().flush();
    }

    @Override
    public void removeCampusCode(InCampusCode campusCode) {
        campusCodeDao.remove(campusCode, Util.getCurrentUser());
        sessionFactory.getCurrentSession().flush();
    }
    ...
    //====================================================================================================
    @Override
    public void saveCollegeCode(InCollegeCode collegeCode) {
        collegeCodeDao.save(collegeCode, Util.getCurrentUser());
        sessionFactory.getCurrentSession().flush();
    }

    @Override
    public void updateCollegeCode(InCollegeCode collegeCode) {
        collegeCodeDao.update(collegeCode, Util.getCurrentUser());
        sessionFactory.getCurrentSession().flush();
    }

    @Override
    public void removeCollegeCode(InCollegeCode collegeCode) {
        collegeCodeDao.remove(collegeCode, Util.getCurrentUser());
        sessionFactory.getCurrentSession().flush();
    }
    ...
    //====================================================================================================
    @Override
    public void saveCompetencyCode(InCompetencyCode competencyCode) {
        competencyCodeDao.save(competencyCode, Util.getCurrentUser());
        sessionFactory.getCurrentSession().flush();
    }

    @Override
    public void updateCompetencyCode(InCompetencyCode competencyCode) {
        competencyCodeDao.update(competencyCode, Util.getCurrentUser());
        sessionFactory.getCurrentSession().flush();
    }

    @Override
    public void removeCompetencyCode(InCompetencyCode competencyCode) {
        competencyCodeDao.remove(competencyCode, Util.getCurrentUser());
        sessionFactory.getCurrentSession().flush();
    }
    ...
    @Override
    public void saveLocationCode(InLocationCode locationCode) {
        locationCodeDao.save(locationCode, Util.getCurrentUser());
        sessionFactory.getCurrentSession().flush();
    }

    @Override
    public void updateLocationCode(InLocationCode locationCode) {
        locationCodeDao.update(locationCode, Util.getCurrentUser());
        sessionFactory.getCurrentSession().flush();
    }

    @Override
    public void removeLocationCode(InLocationCode locationCode) {
        locationCodeDao.remove(locationCode, Util.getCurrentUser());
        sessionFactory.getCurrentSession().flush();
    }
    ...
    @Override
    public InCampusCode findCampusCodeById(Long id) {
        return campusCodeDao.findById(id);
    }

    @Override
    public InCampusCode findCampusCodeByCode(String code) {
        return campusCodeDao.findByCode(code);
    }

    @Override
    public List<InCampusCode> findCampusCodes() {
        return campusCodeDao.find();
    }

    @Override
    public List<InCampusCode> findCampusCodes(String filter, Integer offset, Integer limit) {
    ...
    @Override
    public InCollegeCode findCollegeCodeById(Long id) {
        return collegeCodeDao.findById(id);
    }

    @Override
    public InCollegeCode findCollegeCodeByCode(String code) {
        return collegeCodeDao.findByCode(code);
    }

    @Override
    public List<InCollegeCode> findCollegeCodes() {
        return collegeCodeDao.find();
    }

    @Override
    public List<InCollegeCode> findCollegeCodes(String filter, Integer offset, Integer limit) {
        return collegeCodeDao.find(filter, offset, limit);
    }

    @Override
    public Integer countCollegeCode() {
        return collegeCodeDao.count();
    }

    @Override
    public Integer countCollegeCode(String filter) {
        return collegeCodeDao.count(filter);
    }
    ...
    @Override
    public InCompetencyCode findCompetencyCodeById(Long id) {
        return competencyCodeDao.findById(id);
    }

    @Override
    public InCompetencyCode findCompetencyCodeByCode(String code) {
        return competencyCodeDao.findByCode(code);
    }

    @Override
    public List<InCompetencyCode> findCompetencyCodes() {
        return competencyCodeDao.find();
    }

    @Override
    public List<InCompetencyCode> findCompetencyCodes(Integer offset, Integer limit) {
        return competencyCodeDao.find(offset, limit);
    }

    @Override
    public List<InCompetencyCode> findCompetencyCodes(String filter, Integer offset, Integer limit) {
        return competencyCodeDao.find(filter, offset, limit);
    }

    @Override
    public Integer countCompetencyCode() {
        return competencyCodeDao.count();
    }

    @Override
    public Integer countCompetencyCode(String filter) {
        return competencyCodeDao.count(filter);
    }
    ...
    @Override
    public InLocationCode findLocationCodeById(Long id) {
        return locationCodeDao.findById(id);
    }

    @Override
    public InLocationCode findLocationCodeByCode(String code) {
        return locationCodeDao.findByCode(code);
    }

    @Override
    public List<InLocationCode> findLocationCodes() {
        return locationCodeDao.find();
    }

    @Override
    public List<InLocationCode> findLocationCodes(Integer offset, Integer limit) {
        return locationCodeDao.find(offset, limit);
    }

    @Override
    public List<InLocationCode> findLocationCodes(String filter, Integer offset, Integer limit) {
        return locationCodeDao.find(filter, offset, limit);
    }

    @Override
    public Integer countLocationCode() {
        return locationCodeDao.count();
    }

    @Override
    public Integer countLocationCode(String filter) {
        return locationCodeDao.count(filter);
    }
