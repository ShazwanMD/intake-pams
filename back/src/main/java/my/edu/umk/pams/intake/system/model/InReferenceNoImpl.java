...
@Table(name = "IN_RFRN_NO")
public class InReferenceNoImpl implements InReferenceNo {

    @Id
    @Column(name = "ID", nullable = false)
    @GeneratedValue(generator = "SQ_IN_RFRN_NO")
    @SequenceGenerator(name = "SQ_IN_RFRN_NO", sequenceName = "SQ_IN_RFRN_NO", allocationSize = 1)
    private Long id;
