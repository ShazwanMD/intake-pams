...
CREATE TABLE IN_INTK (
  ...
  CANCEL_COMMENT VARCHAR(255)  NULL,
  DESCRIPTION    VARCHAR(255) NOT NULL,
  END_DATE       TIMESTAMP    NOT NULL,
  AV_TS          TIMESTAMP,
  AV_ID          INT8,
  ...
  REMOVE_COMMENT VARCHAR(255)  NULL,
...
ALTER TABLE IN_LCTN_CODE
  ADD CONSTRAINT uc_IN_LCTN_CODE_1 UNIQUE (CODE);
...
CREATE SEQUENCE SQ_IN_LCTN_CODE;
