   ...
   ALTER TABLE IN_CNDT
    ...
    ALTER TABLE IN_CNDT
        ADD CONSTRAINT FKA01B411554B90F80P
    ...
    ALTER TABLE IN_INTK_APLN
        ADD CONSTRAINT UC_IN_INTK_APLN_2 UNIQUE (PROMO_CODE);    
        
    ALTER TABLE IN_INTK_APLN
        ADD CONSTRAINT FK5974F5ABDADE6E1
    ...
    ALTER TABLE IN_FCTY_CODE
        ADD CONSTRAINT FKA01C278637A6ABC9
    ...
    ALTER TABLE IN_STAF
        ADD CONSTRAINT FK6B49ECA2DDCRTT7
        FOREIGN KEY (FACULTY_CODE_ID)
        REFERENCES IN_FCTY_CODE;     
        
    ALTER TABLE IN_STAF
        ADD CONSTRAINT FK6B49ECA2DDDFWW2
        FOREIGN KEY (PROGRAM_CODE_ID)
        REFERENCES IN_PRGM_CODE;        
    ...
    CREATE SEQUENCE SQ_IN_PROMO_CODE;
