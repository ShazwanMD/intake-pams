...
VALUES (nextval('SQ_IN_RFRN_NO'), 'InIntake.referenceNo', 1, 'Intake Reference No Format', 1, 'IN', '{#graduateCentre.getCode()}-{#intakeSession.getCode()}-{#programLevel.getCode()}-{#j}', '000', 1, 0, CURRENT_TIMESTAMP );
