import { CandidateProfileDialog } from './../../admission/dialog/candidate-profile.dialog';
import { AdmissionActions } from './../../admission/admission.action';
import { AdmissionModuleState } from './../../admission/index';
...
@Component({
  selector: 'pams-result-candidate-list',
  templateUrl: './result-candidate-list.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ResultCandidateListComponent {
