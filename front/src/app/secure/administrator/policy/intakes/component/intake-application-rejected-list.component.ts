...
@Component({
  selector: 'pams-intake-application-rejected-list',
  templateUrl: './intake-application-rejected-list.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class IntakeApplicationRejectedListComponent {

  @Input() intake: Intake;
  @Input() intakeRejectedApplications: IntakeApplication;
