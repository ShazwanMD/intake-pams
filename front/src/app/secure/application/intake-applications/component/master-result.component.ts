...
export class MasterResultComponent {
  ...
  private editorDialogRef: MdDialogRef<MasterResultEditorDialog>;
  @Input() result: Result;
  ...
  editDialog(): void {
    ...
    this.editorDialogRef = this.dialog.open(MasterResultEditorDialog, config);
