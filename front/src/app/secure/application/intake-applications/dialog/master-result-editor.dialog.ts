...
@Component({
  selector: 'pams-master-result-editor',
  templateUrl: './master-result-editor.dialog.html',
})

export class MasterResultEditorDialog implements OnInit {
  ...
  constructor(private router: Router,
              ...
              private dialog: MdDialogRef<MasterResultEditorDialog>) {
  }
