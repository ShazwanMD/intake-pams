...
@Component({
  selector: 'pams-phd-result-editor',
  templateUrl: './phd-result-editor.dialog.html',
})

export class PhdResultEditorDialog implements OnInit {
  ...
  constructor(private router: Router,
              ...
              private dialog: MdDialogRef<PhdResultEditorDialog>) {
  }
